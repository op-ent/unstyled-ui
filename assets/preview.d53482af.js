import{f as M,k as E,w as A,s as b,Y as h}from"./iframe.b64a4fb6.js";var c="backgrounds",{document:l,window:L}=A,B=()=>L.matchMedia("(prefers-reduced-motion: reduce)").matches,H=(r,e=[],t)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let n=e.find(a=>a.name===t);if(n)return n.value;if(t){let a=e.map(o=>o.name).join(", ");M.warn(E`
    ...
    `},[i]);return h(()=>{let m=e.viewMode==="docs"?`addon-backgrounds-grid-docs-${e.id}`:"addon-backgrounds-grid";if(!o){k(m);return}F(m,f)},[o,f,e]),r()},S=[C,z],Y={[c]:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}},O={[c]:null};export{S as decorators,O as globals,Y as parameters};
//# sourceMappingURL=preview.d53482af.js.map
